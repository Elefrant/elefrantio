...
Elefrant.prototype.init = function (callback) {
	...
	elefrant.register('elefrant', elefrant.status);

	elefrant.version = elefrant.config.server.version || elefrant.version;
	elefrant.name = elefrant.config.server.name || elefrant.name;
